  ...
  <div style="max-width: 480px;" class="w-100">
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <?= Html::submitButton('Sign In', ['class' => 'btn btn-primary', 'name' => 'sign-in-button', 'tabIndex' => 4]) ?>

        <?php ActiveForm::end(); ?>
        <?php endif; ?>
      </div>
    </div>
    <p class="text-center">Don't have an account yet? <a href="/auth/sign-up">Sign Up</a> here.</p>
  </div>
</div>